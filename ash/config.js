/* ------------------------------------------------------------------
   Front-end config. Safe to commit — these are PUBLIC keys only.
   Leave the Supabase fields blank to run in "local only" mode
   (your edits stay in one browser). Fill them in to sync across devices.
   ------------------------------------------------------------------ */
window.CONFIG = {
  ...
  STATE_ID: "ash-block1",        // Ash's row of edits
